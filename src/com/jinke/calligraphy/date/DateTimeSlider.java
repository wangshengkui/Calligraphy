...
public class DateTimeSlider extends DateSlider {
	...
	public DateTimeSlider(Context context, OnDateSetListener l,	Calendar calendar , Calendar minDate) {
		this(context, l, calendar, minDate, null);
	}
...
//            mTitleText.setText(String.format("您选择的日期: %te/%tm/%ty %tH:%02d",
//                    c,c,c,c,minute));
            
            mTitleText.setText(String.format("您选择的日期: 	%ty年%tm月%te日	 %tH:%02d",
                    c,c,c,c,minute));
